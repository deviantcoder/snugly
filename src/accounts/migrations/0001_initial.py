# Generated by Django 5.1.6 on 2025-03-02 11:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'Regular'), ('mentor', 'Mentor'), ('manager', 'Manager'), ('admin', 'Admin')], default='user', max_length=15)),
        ...
        migrations.CreateModel(
            name='ManagerProfile',
            fields=[
                ('image', models.ImageField(blank=True, default='img/def.png', upload_to=accounts.models.upload_to)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='skills', to='accounts.mentorprofile')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
