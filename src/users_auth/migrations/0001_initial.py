# Generated by Django 5.1.6 on 2025-03-01 18:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            bases=('users_auth.appuser',),
        ),
        migrations.CreateModel(
            name='ManagerProfile',
            fields=[
                ('image', models.ImageField(blank=True, default='img/def.png', upload_to=users_auth.models.upload_to)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='skills', to='users_auth.mentorprofile')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
